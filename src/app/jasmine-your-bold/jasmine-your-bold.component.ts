...
@Component({
  selector: 'app-jasmine-your-bold',
  templateUrl: './jasmine-your-bold.component.html',
  styleUrls: ['./jasmine-your-bold.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class JasmineYourBoldComponent implements OnInit {
  @ViewChild("jasmineyourbold") jasmineyourbold: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['jasmineyourbold'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.jasmineyourbold.nativeElement.innerHTML = data;
          }
        }
      });
  }
