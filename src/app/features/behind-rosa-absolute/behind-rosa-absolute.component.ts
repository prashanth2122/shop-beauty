...
@Component({
  selector: 'app-behind-rosa-absolute',
  templateUrl: './behind-rosa-absolute.component.html',
  styleUrls: ['./behind-rosa-absolute.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class BehindRosaAbsoluteComponent implements OnInit {
  
  @ViewChild("rosaabsolute") rosaabsolute: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['rosaabsolute'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.rosaabsolute.nativeElement.innerHTML = data;
          }
        }
      });
  }
