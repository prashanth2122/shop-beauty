...
@Component({
  selector: 'app-green-eyed-girl',
  templateUrl: './green-eyed-girl.component.html',
  styleUrls: ['./green-eyed-girl.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class GreenEyedGirlComponent implements OnInit {
  @ViewChild("greeneyedgirl") greeneyedgirl: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['greeneyedgirl'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.greeneyedgirl.nativeElement.innerHTML = data;
          }
        }
      });
  }
