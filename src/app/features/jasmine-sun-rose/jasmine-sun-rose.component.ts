...
@Component({
  selector: 'app-jasmine-sun-rose',
  templateUrl: './jasmine-sun-rose.component.html',
  styleUrls: ['./jasmine-sun-rose.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class JasmineSunRoseComponent implements OnInit {
  
  @ViewChild("jasminsunrose") jasminsunrose: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['jasminsunrose'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.jasminsunrose.nativeElement.innerHTML = data;
          }
        }
      });
  }
