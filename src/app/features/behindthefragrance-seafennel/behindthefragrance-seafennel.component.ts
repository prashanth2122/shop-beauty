...
@Component({
  selector: 'app-behindthefragrance-seafennel',
  templateUrl: './behindthefragrance-seafennel.component.html',
  styleUrls: ['./behindthefragrance-seafennel.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class BehindthefragranceSeafennelComponent implements OnInit {

  @ViewChild("seafennel") seafennel: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['seafennel'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.seafennel.nativeElement.innerHTML = data;
          }
        }
      });
  }
