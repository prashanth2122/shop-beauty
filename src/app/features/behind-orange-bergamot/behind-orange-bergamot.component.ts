...
@Component({
  selector: 'app-behind-orange-bergamot',
  templateUrl: './behind-orange-bergamot.component.html',
  styleUrls: ['./behind-orange-bergamot.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class BehindOrangeBergamotComponent implements OnInit {

  @ViewChild("bergamot") bergamot: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['bergamot'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.bergamot.nativeElement.innerHTML = data;
          }
        }
      });
  }
