...
@Component({
  selector: 'app-geranium-nefertum-bhf',
  templateUrl: './geranium-nefertum-bhf.component.html',
  styleUrls: ['./geranium-nefertum-bhf.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class GeraniumNefertumBhfComponent implements OnInit {
  @ViewChild("geraniumnefertumbhf") geraniumnefertumbhf: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['behind-the-fragrance'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.geraniumnefertumbhf.nativeElement.innerHTML = data;
          }
        }
      });
  }
