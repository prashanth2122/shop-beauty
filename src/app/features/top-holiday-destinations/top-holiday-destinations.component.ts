...
@Component({
  selector: 'app-top-holiday-destinations',
  templateUrl: './top-holiday-destinations.component.html',
  styleUrls: ['./top-holiday-destinations.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class TopHolidayDestinationsComponent implements OnInit {
  
  @ViewChild("topholidaydestination") topholidaydestination: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['topholidaydestination'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.topholidaydestination.nativeElement.innerHTML = data;
          }
        }
      });
  }
