...
@Component({
  selector: 'app-design-at-nineteen',
  templateUrl: './design-at-nineteen.component.html',
  styleUrls: ['./design-at-nineteen.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class DesignAtNineteenComponent implements OnInit {
  @ViewChild("designatnineteen") designatnineteen: ElementRef;
  param1: string;
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['designatnineteen'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.designatnineteen.nativeElement.innerHTML = data;
          }
        }
      });
  }
