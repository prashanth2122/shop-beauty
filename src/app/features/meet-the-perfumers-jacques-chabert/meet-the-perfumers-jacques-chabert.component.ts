...
@Component({
  selector: 'app-meet-the-perfumers-jacques-chabert',
  templateUrl: './meet-the-perfumers-jacques-chabert.component.html',
  styleUrls: ['./meet-the-perfumers-jacques-chabert.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class MeetThePerfumersJacquesChabertComponent implements OnInit {
  @ViewChild("jacqueschabert") jacqueschabert: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['jacqueschabert'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.jacqueschabert.nativeElement.innerHTML = data;
          }
        }
      });
  }
