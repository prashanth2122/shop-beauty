...
@Component({
  selector: 'app-perfumers-jerome-di-marino',
  templateUrl: './perfumers-jerome-di-marino.component.html',
  styleUrls: ['./perfumers-jerome-di-marino.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class PerfumersJeromeDiMarinoComponent implements OnInit {
  @ViewChild("jeromedimarino") jeromedimarino: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['jeromedimarino'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.jeromedimarino.nativeElement.innerHTML = data;
          }
        }
      });
  }
