...
@Component({
  selector: 'app-perfumers-carlachabert',
  templateUrl: './perfumers-carlachabert.component.html',
  styleUrls: ['./perfumers-carlachabert.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class PerfumersCarlachabertComponent implements OnInit {
  @ViewChild("perfumerscarlachabert") perfumerscarlachabert: ElementRef;
  param1: string;
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['meet-the-perfumers-carla-chabert'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.perfumerscarlachabert.nativeElement.innerHTML = data;
          }
        }
      });
  }
