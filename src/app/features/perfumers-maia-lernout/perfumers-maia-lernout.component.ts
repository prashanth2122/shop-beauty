...
@Component({
  selector: 'app-perfumers-maia-lernout',
  templateUrl: './perfumers-maia-lernout.component.html',
  styleUrls: ['./perfumers-maia-lernout.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class PerfumersMaiaLernoutComponent implements OnInit {
  @ViewChild("maialemout") maialemout: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['maialemout'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.maialemout.nativeElement.innerHTML = data;
          }
        }
      });
  }
