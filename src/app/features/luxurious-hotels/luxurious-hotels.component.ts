...
@Component({
  selector: 'app-luxurious-hotels',
  templateUrl: './luxurious-hotels.component.html',
  styleUrls: ['./luxurious-hotels.component.scss'],
  encapsulation:ViewEncapsulation.None

})
export class LuxuriousHotelsComponent implements OnInit {
  @ViewChild("luxurioushotels") luxurioushotels: ElementRef;
  param1: string;
  ...
  ngOnInit() {
    this.titleService.setTitle('Guide to Luxury Hotels in Condé Nast Traveler | Molton Brown® UK');
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['conde-nast-traveler-hotel-guide'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.luxurioushotels.nativeElement.innerHTML = data;
          }
        }
      });
  }
