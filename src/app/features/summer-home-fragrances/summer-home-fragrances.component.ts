...
@Component({
  selector: 'app-summer-home-fragrances',
  templateUrl: './summer-home-fragrances.component.html',
  styleUrls: ['./summer-home-fragrances.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class SummerHomeFragrancesComponent implements OnInit {
  @ViewChild("summerhome") summerhome: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['summerhome'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.summerhome.nativeElement.innerHTML = data;
          }
        }
      });
  }
