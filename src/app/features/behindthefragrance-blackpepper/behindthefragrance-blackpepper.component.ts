...
@Component({
  selector: 'app-behindthefragrance-blackpepper',
  templateUrl: './behindthefragrance-blackpepper.component.html',
  styleUrls: ['./behindthefragrance-blackpepper.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class BehindthefragranceBlackpepperComponent implements OnInit {
  @ViewChild("blackpepper") blackpepper: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['blackpepper'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.blackpepper.nativeElement.innerHTML = data;
          }
        }
      });
  }
