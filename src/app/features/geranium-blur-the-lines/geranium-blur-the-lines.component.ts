...
@Component({
  selector: 'app-geranium-blur-the-lines',
  templateUrl: './geranium-blur-the-lines.component.html',
  styleUrls: ['./geranium-blur-the-lines.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class GeraniumBlurTheLinesComponent implements OnInit {
  @ViewChild("geraniumnblurthelines") geraniumnblurthelines: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['geraniumnblurthelines'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.geraniumnblurthelines.nativeElement.innerHTML = data;
          }
        }
      });
  }
