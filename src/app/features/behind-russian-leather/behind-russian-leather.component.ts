...
@Component({
  selector: 'app-behind-russian-leather',
  templateUrl: './behind-russian-leather.component.html',
  styleUrls: ['./behind-russian-leather.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class BehindRussianLeatherComponent implements OnInit {
  @ViewChild("russianleather") russianleather: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['russianleather'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.russianleather.nativeElement.innerHTML = data;
          }
        }
      });
  }
