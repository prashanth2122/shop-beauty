...
@Component({
  selector: 'app-behind-online-exclusive',
  templateUrl: './behind-online-exclusive.component.html',
  styleUrls: ['./behind-online-exclusive.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class BehindOnlineExclusiveComponent implements OnInit {
  @ViewChild("onlineexclusive") onlineexclusive: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['onlineexclusive'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.onlineexclusive.nativeElement.innerHTML = data;
          }
        }
      });
  }
