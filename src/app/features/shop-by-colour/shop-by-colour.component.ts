...
@Component({
  selector: 'app-shop-by-colour',
  templateUrl: './shop-by-colour.component.html',
  styleUrls: ['./shop-by-colour.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class ShopByColourComponent implements OnInit {
  @ViewChild("shopbycolour") shopbycolour: ElementRef;
  param1: string;
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['shopbycolour'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.shopbycolour.nativeElement.innerHTML = data;
          }
        }
      });
  }
