...
@Component({
  selector: 'app-refillable-fragrance',
  templateUrl: './refillable-fragrance.component.html',
  styleUrls: ['./refillable-fragrance.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class RefillableFragranceComponent implements OnInit {
  
  @ViewChild("refillablefragrance") refillablefragrance: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['refillablefragrance'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.refillablefragrance.nativeElement.innerHTML = data;
          }
        }
      });
  }
