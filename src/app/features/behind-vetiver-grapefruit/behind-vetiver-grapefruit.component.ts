...
@Component({
  selector: 'app-behind-vetiver-grapefruit',
  templateUrl: './behind-vetiver-grapefruit.component.html',
  styleUrls: ['./behind-vetiver-grapefruit.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class BehindVetiverGrapefruitComponent implements OnInit {
  @ViewChild("grapefruit") grapefruit: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['grapefruit'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.grapefruit.nativeElement.innerHTML = data;
          }
        }
      });
  }
