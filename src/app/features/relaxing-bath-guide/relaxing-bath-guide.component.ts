...
@Component({
  selector: 'app-relaxing-bath-guide',
  templateUrl: './relaxing-bath-guide.component.html',
  styleUrls: ['./relaxing-bath-guide.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class RelaxingBathGuideComponent implements OnInit {
  
  @ViewChild("relaxingbathguide") relaxingbathguide: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['relaxingbathguide'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.relaxingbathguide.nativeElement.innerHTML = data;
          }
        }
      });
  }
