...
@Component({
  selector: 'app-molton-brown-history',
  templateUrl: './molton-brown-history.component.html',
  styleUrls: ['./molton-brown-history.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class MoltonBrownHistoryComponent implements OnInit {
  @ViewChild("mbhistoryf") mbhistory: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['mbhistory'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.mbhistory.nativeElement.innerHTML = data;
          }
        }
      });
  }
