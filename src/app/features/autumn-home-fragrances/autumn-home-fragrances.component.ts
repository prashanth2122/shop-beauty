...
@Component({
  selector: 'app-autumn-home-fragrances',
  templateUrl: './autumn-home-fragrances.component.html',
  styleUrls: ['./autumn-home-fragrances.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class AutumnHomeFragrancesComponent implements OnInit {
  
  @ViewChild("autumnhome") autumnhome: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['autumnhome'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.autumnhome.nativeElement.innerHTML = data;
          }
        }
      });
  }
