...
@Component({
  selector: 'app-gift-wrapping-services',
  templateUrl: './gift-wrapping-services.component.html',
  styleUrls: ['./gift-wrapping-services.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class GiftWrappingServicesComponent implements OnInit {

  @ViewChild("giftwrappingservice") giftwrappingservice: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['giftwrappingservice'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.giftwrappingservice.nativeElement.innerHTML = data;
          }
        }
      });
  }
