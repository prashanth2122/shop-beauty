...
@Component({
  selector: 'app-healthy-hair-care-routine',
  templateUrl: './healthy-hair-care-routine.component.html',
  styleUrls: ['./healthy-hair-care-routine.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class HealthyHairCareRoutineComponent implements OnInit {
  @ViewChild("healthyhaircareroutine") healthyhaircareroutine: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['healthyhaircareroutine'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.healthyhaircareroutine.nativeElement.innerHTML = data;
          }
        }
      });
  }
