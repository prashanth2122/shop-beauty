...
@Component({
  selector: 'app-christmas-recipes-with-mother-cooker',
  templateUrl: './christmas-recipes-with-mother-cooker.component.html',
  styleUrls: ['./christmas-recipes-with-mother-cooker.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class ChristmasRecipesWithMotherCookerComponent implements OnInit {
  
  @ViewChild("christmasrecipes") christmasrecipes: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['christmasrecipes'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.christmasrecipes.nativeElement.innerHTML = data;
          }
        }
      });
  }
