...
@Component({
  selector: 'app-toilette-eau-de-parfum',
  templateUrl: './toilette-eau-de-parfum.component.html',
  styleUrls: ['./toilette-eau-de-parfum.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class ToiletteEauDeParfumComponent implements OnInit {
  
  @ViewChild("toiletteeau") toiletteeau: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['toiletteeau'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.toiletteeau.nativeElement.innerHTML = data;
          }
        }
      });
  }
