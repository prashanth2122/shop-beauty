...
@Component({
  selector: 'app-behind-rhubarb-rose',
  templateUrl: './behind-rhubarb-rose.component.html',
  styleUrls: ['./behind-rhubarb-rose.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class BehindRhubarbRoseComponent implements OnInit {
  
  @ViewChild("rhubarbrose") rhubarbrose: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['rhubarbrose'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.rhubarbrose.nativeElement.innerHTML = data;
          }
        }
      });
  }
