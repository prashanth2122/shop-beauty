...
@Component({
  selector: 'app-behindthefragrance-pinkpepper',
  templateUrl: './behindthefragrance-pinkpepper.component.html',
  styleUrls: ['./behindthefragrance-pinkpepper.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class BehindthefragrancePinkpepperComponent implements OnInit {
  
  @ViewChild("pinkpepper") pinkpepper: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['pinkpepper'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.pinkpepper.nativeElement.innerHTML = data;
          }
        }
      });
  }
