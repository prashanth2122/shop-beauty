...
@Component({
  selector: 'app-online-perfume-shopping-guide',
  templateUrl: './online-perfume-shopping-guide.component.html',
  styleUrls: ['./online-perfume-shopping-guide.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class OnlinePerfumeShoppingGuideComponent implements OnInit {

  @ViewChild("onlineperfumeguide") onlineperfumeguide: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['onlineperfumeguide'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.onlineperfumeguide.nativeElement.innerHTML = data;
          }
        }
      });
  }
