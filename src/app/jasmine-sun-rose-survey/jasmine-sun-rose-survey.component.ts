...
@Component({
  selector: 'app-jasmine-sun-rose-survey',
  templateUrl: './jasmine-sun-rose-survey.component.html',
  styleUrls: ['./jasmine-sun-rose-survey.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class JasmineSunRoseSurveyComponent implements OnInit {
  @ViewChild("jasminesunrose") jasminesunrose: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['jasminesunrose'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.jasminesunrose.nativeElement.innerHTML = data;
          }
        }
      });
  }
