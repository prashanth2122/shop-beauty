...
@Component({
  selector: 'app-at-home-with-lust-living',
  templateUrl: './at-home-with-lust-living.component.html',
  styleUrls: ['./at-home-with-lust-living.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class AtHomeWithLustLivingComponent implements OnInit {
  
  @ViewChild("homewithlust") homewithlust: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    ...
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['homewithlust'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.homewithlust.nativeElement.innerHTML = data;
          }
        }
      });
  }
