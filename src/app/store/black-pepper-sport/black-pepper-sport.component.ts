...
@Component({
  selector: 'app-black-pepper-sport',
  templateUrl: './black-pepper-sport.component.html',
  styleUrls: ['./black-pepper-sport.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class BlackPepperSportComponent implements OnInit {
  
  @ViewChild("blackpeppersport") blackpeppersport: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['blackpeppersport'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.blackpeppersport.nativeElement.innerHTML = data;
          }
        }
      });
  }
