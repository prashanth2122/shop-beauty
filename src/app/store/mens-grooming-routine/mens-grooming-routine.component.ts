...
@Component({
  selector: 'app-mens-grooming-routine',
  templateUrl: './mens-grooming-routine.component.html',
  styleUrls: ['./mens-grooming-routine.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class MensGroomingRoutineComponent implements OnInit {

  @ViewChild("mensgrooming") mensgrooming: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["feature"]['mensgrooming'];
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.mensgrooming.nativeElement.innerHTML = data;
          }
        }
      });
  }
