...
@Component({
  selector: 'app-corporate-social-reponsibility',
  templateUrl: './corporate-social-reponsibility.component.html',
  styleUrls: ['./corporate-social-reponsibility.component.scss']
})
export class CorporateSocialReponsibilityComponent implements OnInit {

  
  @ViewChild("socialResponsibility") socialResponsibility: ElementRef;
  param1: string;
  constructor(
  ...
  setLang(lng) {
    this.featureServ.getStaticContent(lng).subscribe(response => {
      ...
      const _data = response["store"]['socialResponsibility']['content'];
      this.titleService.setTitle(_data.titleName);
    ...
    const baseSite = this.singletonServ.catalogVersion;
      ...
      AmpCa.utils.getHtmlServiceData({
        ...
        callback: function(data) {
          if (data) {
            that.socialResponsibility.nativeElement.innerHTML = data;
          }
        }
      });
  }
