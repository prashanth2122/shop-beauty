...
export const environment :{
  ...
  countryJsonData:[
  {
    ...
    query:"https://www.uath.moltonbrown.co.uk/store/index",
    hostname:"www.uath.moltonbrown.co.uk",
    serverName:"uath.moltonbrown.co.uk",
    personaId:'GBPERSONA',
  ...
  },
  {
    ...
    query:"https://www.uath.moltonbrown.com/store/index?country_store=us",
    hostname:"www.uath.moltonbrown.com",
    serverName:"uath.moltonbrown.com",
    personaId:'USPERSONA',
  ...
  },
  {
    ...
    query:"https://www.uath.moltonbrown.eu/store/index?country_store=eu",
    hostname:"www.uath.moltonbrown.eu",
    serverName:"uath.moltonbrown.eu",
    personaId:'EUPERSONA',
  ...
  },
  {
    ...
    query:"https://www.uath.moltonbrown.de/store/index?country_store=de",
    hostname:"www.uath.moltonbrown.de",
    serverName:"uath.moltonbrown.de",
    personaId:'DEPERSONA',
